  ...
  return (
    <section className='relative max-container padding-container xs:py-12 sm:py-28 xs:gap-16 sm:gap-32 gap-0 flex flex-col xl:flex-row'>
      ...
      <div className='relative z-2 flex flex-1 flex-col gap-8 xl:w-2/5'>
        ...
        <h1 className='sm:text-6xl xs:text-6xl font-semibold'>Travel <span className='text-[#F85E9F]'>top destination </span>of the world</h1>
        <p className='text-[#191825] text-opacity-50 text-l'>We always make our customer happy by providing <br/> as many choices as possible </p>
