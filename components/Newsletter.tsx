    ...
    <section className='relative'>
      ...
      <div className='bg-[#fff9e8] xs:mx-8 lg:mx-24 xs:px-8 lg:padding-container xs:py-16 lg:py-28 flex flex-col xs:gap-12 lg:gap-20'>
        <div className='flexCenter flex-col gap-4'>
          ...
          <h1 className='font-bold xs:text-1xl sm:text-2xl md:text-3xl lg:text-6xl text-center'>Prepare yourself & let’s explore the beauty of the world</h1>
        </div>
        ...
        <div className='flexCenter xs:gap-4 lg:gap-8 w-full relative'>
    <img src='emaillogo.png' alt='Email Icon' className='absolute left-4 top-1/2 transform -translate-y-1/2' />
    <input className='xs:py-4 lg:py-6 px-12 pl-16 rounded-2xl w-full' type='text' placeholder='Your Email' />
    <button className='rounded-2xl bg-[#5D50C6] xs:text-sm lg:text-lg xs:px-4 lg:px-12 xs:py-4 lg:py-6 text-white'>Subscribe</button>
</div>
