    ...
    <footer className='relative max-container padding-container py-36 flex xs:gap-12 lg:gap-20 xs:flex-col lg:flex-row'>
      ...
      <div className='flex flex-col gap-12 lg:w-1/3'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='opacity-70' style={{ fontSize: '20px' ,fontWeight:'bold', color: '#666666' }}>
  Contrary to popular <br/> belief, Lorem Ipsum is<br/> not simply random text.<br/> It has roots<br/>
  in a piece of classical<br/> Latin literature from 45<br/>   BC.
</p>
      ...
      <div className='right lg:w-2/3 flex xs:flex-col md:flex-row xs:gap-10 md:gap-0 md:justify-between'>
        ...
        <FooterCard title='Meet Us' link1='+00 92 1234 56789' link2='info@travlog.com' link3='205. R Street, New York'  link4='BD23200' />
